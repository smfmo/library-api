...
public class AuthorizationServerConfiguration {
    ...
    public JWKSource<SecurityContext> jwkSource() throws Exception {
        RSAKey rsaKey = gerarChaveRSA(); //Chave usada em criptografia assimétrica
    ...
    public AuthorizationServerSettings authorizationServerSettings(){
        return AuthorizationServerSettings.builder()
                ...
                .jwkSetEndpoint("/oauth2/jwks") //obter chave pública para verificar a assinatura do token
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> tokenCustomizer() {
        return context -> {
            ...
            if (principal instanceof CustomAuthentication authentication){
                OAuth2TokenType tipo = context.getTokenType();

                if (OAuth2TokenType.ACCESS_TOKEN.equals(tipo)){
